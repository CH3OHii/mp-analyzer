export const en = {
  ...
  webSearchToggle: "Web search — the model can look up live policy, launch, price, and market info",
  ...
  edit: "Edit",
  templateName: "Name",
  templateBody: "Template — {variable} becomes a fill-in field",
  templateExample: 'e.g. 分析{月份}的NEV销量，对比{品牌} — braces mark the variables',
  insertTemplate: "Insert",
  fillVariables: "Fill in the variables",
  libraryEmpty: "No templates yet — create one below for prompts you reuse monthly.",
  cancel: "Cancel",
